...
> Diese Season haben alle Spieler, die mehr als `550` Stunden auf dem Server verbracht haben, den
> Veteranen-Rang
> erhalten.
>
...
<chapter title="Die wichtigsten Koordinaten" collapsible="true" id="points-of-interest-1_20">

| Name (Grundstück)          | Spielername                                                                                                                      | Welt      | Koordinaten     | Beschreibung                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|:---------------------------|:---------------------------------------------------------------------------------------------------------------------------------|:----------|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Base & Natur               | Oscar2060 (Mitglieder: Fantasie_Craft)                                                                                           | Overworld | 75 80 -233      | Angefangen hat das Ganze bei dem eckigen schwarzen Haus. Dann ist das Ganze irgendwie ausgeartet und jetzt sieht es so aus, wie es aussieht. Ich hoffe, es gefällt dir <3 LG Oscar                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
> Diese Season haben alle Spieler, die mehr als `200` Stunden auf dem Server verbracht haben, den
> Veteranen-Rang
> erhalten.
>
...
<br/>
<br/>
<chapter title="Die wichtigsten Koordinaten" collapsible="true" id="points-of-interest-1_19">
...
| Space Battleship Yamato + Leuchtturm          | `nikola200655`, `Progeilo`                                                                                                                                                     | Overworld | `538 154 440`     | Das Anime-Schiff (nicht fertig :PepeHands:), Leuchtturm, 2 Lager von Progeilo, 1 künstliche Höhle, in die das Schiff sollte :z0mCopium:, 2 Baumfarmen (von Keks kaputt gemacht). Sehr viel ist unterirdisch                                                |
...
| Netcastle & co.                               | `BlockNic`, `Twisti_twixi`, `Fuximus`, `BlockLukeHD`, `AlexMaro`, `Trytan`, `SirMax`, `SiderealPuppy90`, `PowerCraft`, <code>Gost&#124;Pixel</code>, `Richart3855`, `Jo_Field` | Overworld | `-555 218 3903`   | - Große Netherburg inspiriert von Loony mit vielen Farmen und Redstoneschaltungen, z. B. Goldfabrik, Casino und Google Dino-Game etc. - Jesus-Statue aus Rio - Riesiger Steinelefant und vieles mehr in der Umgebung. ![Netcastle](netcastle-overview.png) |
| Sci-Fi Pyramide                               | `Sheppardt98`                                                                                                                                                                  | Overworld | `8435 142 -2721`  | Das ist physikalisch unmöglich.                                                                                                                                                                                                                            |
| Community Tempel                              | `Erzengel_36`, `Firedr4gon24`                                                                                                                                                  | Overworld | `-2304 100 84`    | Großer Tempel, der viele Spieler des Servers verewigt                                                                                                                                                                                                      |
| Xenus Base                                    | `Xenus_LP`                                                                                                                                                                     | Overworld | `-2568 114 4036`  | Großer Militärhafen mit U-Booten, einem Kreuzer, Flugzeugen und anderen Fahrzeugen                                                                                                                                                                         |
| Strand mit einigen Spielern des Servers & co. | `la__laura_`                                                                                                                                                                   | Overworld | `-5009 70 -6300`  | Ein detaillierter Strand mit dutzenden aufwendig erstellten Rüstungsständern, die die Community widerspiegeln                                                                                                                                              |
| Japanische Tempelanlage                       | `Erzengel_36`, `Firedr4gon24`                                                                                                                                                  | Overworld | `-1140 76 281`    | Riesige Tempelanlage mit vielen Details und Rüstungsständer-Dekorationen                                                                                                                                                                                   |
| Labor Laserbeast                              | `Laserbeast_`                                                                                                                                                                  | Overworld | `-269 46 319`     | Die Koordinaten sind im Lager bei dem Abschiedsbuch, aber das Labor befindet sich eine Etage tiefer in der Erde und ist nicht zu übersehen                                                                                                                 |
...
<br/>
<br/>
<chapter title="Die wichtigsten Koordinaten" collapsible="true" id="points-of-interest-1_18">
